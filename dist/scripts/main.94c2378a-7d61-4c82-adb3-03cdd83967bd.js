...
},{"./chapters":2,"./environment":3,"./events":4,"./hover":5,"./layout":6,"./mobile":8,"./reader":11,"./search":12,"./settings":13,"./shims/storage":14,"./styles":15,"./user-settings":16,"./vendor/jquery":17}],2:[function(require,module,exports){
var $ = require('./vendor/jquery');
        ...
        $.when(getPromise()).done(function () {
            ...
            if (firstArticle === true) {
                ...
                case 'prev':
                    ...
                    break;
                case 'next':
                    pos = $('[data-firstel="true"]').data().posTop;
                    break;
                }
            } else {
...
},{"./events":4,"./settings":13,"./vendor/jquery":17}],3:[function(require,module,exports){
module.exports = {
    tablet: [
        'ipad',
        'android',
...
},{"./layout":6,"./reader":11,"./settings":13,"./user-settings":16,"./vendor/jquery":17}],5:[function(require,module,exports){
var $ = require('./vendor/jquery');
...
},{"./environment":3,"./plugins/hover-intent":10,"./reader":11,"./settings":13,"./vendor/jquery":17}],6:[function(require,module,exports){
var $ = require('./vendor/jquery');
var environment = require('./environment');
var settings = require('./settings');
...
},{"./environment":3,"./settings":13,"./styles":15,"./vendor/jquery":17}],7:[function(require,module,exports){
var $ = require('./vendor/jquery');
var App = require('./app');
...
},{"./app":1,"./vendor/jquery":17}],8:[function(require,module,exports){
var $           = require('./vendor/jquery');
var environment = require('./environment');
var reader      = require('./reader');
var settings    = require('./settings');
...
},{"./environment":3,"./events":4,"./plugins/hammer":9,"./reader":11,"./settings":13,"./vendor/jquery":17}],9:[function(require,module,exports){
...
},{"../vendor/jquery":17}],11:[function(require,module,exports){
module.exports = {
...
},{"./environment":3,"./settings":13,"./vendor/jquery":17}],13:[function(require,module,exports){
var $ = require('./vendor/jquery');
var environment = require('./environment');
module.exports = {
    dev: false,
...
},{"./environment":3,"./vendor/jquery":17}],14:[function(require,module,exports){
        ...
        Object.defineProperty(window, 'localStorage', new(function () {
            ...
            Object.defineProperty(oStorage, 'setItem', {
                value: function (sKey, sValue) {
                    ...
                    document.cookie = escape(sKey) + '=' + escape(sValue) + '; expires=' + oneMonth + '; path=/';
                },
                writable: false,
                configurable: false,
                enumerable: false
...
},{"./settings":13}],16:[function(require,module,exports){
var reader   = require('./reader');
var settings = require('./settings');
...
},{"./reader":11,"./settings":13}],17:[function(require,module,exports){
